...
####################################
# BruteForceAttack_FUCK SSL
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

# Like Limit
LIKE_LIMIT_FILE = 'like_limits.json'
DAILY_LIKE_LIMIT = 5
# REPLACE '1234567890' WITH YOUR ACTUAL NUMERICAL PLAYER UID
OWNER_UID = '12345678' 
...
#Function to manage daily like limits
...
XP: {fix_num(data['xp'])}\n\n
°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[FFB300][b][c]BOT MADE BY iconic_venom
            """
            return msg
        else:
            msg = """
...
def  generate_random_word():
    word_list = [
        ...
        "FAILED_STREAMER", "iconic_venom", "GAY", "YOUR_ASS_IS_PINK", "YOUR_PUSSY_IS_BEAUTIFUL",
        ...
        "LOSER", "FUCK_YOU", "FUCK_YOUR_MOM_SLANG", "FUCK_YOUR_MOM_SLANG2", "I_WILL_JERK_OFF_ON_YOU", "LICKER", " iconic_venom", "TELEGRAM:@S_DD_F"
    ]
                ...
                if "8" in parsed_data["5"]["data"] and "data" in parsed_data["5"]["data"]["8"]:
                    ...
                    if uexmojiii == "DefaultMessageWithKey":
                        ...
                        clients.send(
                            self.GenResponsMsg(
                                f"""[C][B]
Welcome to [00ff00]iconic_venom'S BOT[ffffff]!
...
[C][B][11EAFD]‎━━━━━━
[C][B][FFB300]BOT BY iconic_venom
"""
                        else:
